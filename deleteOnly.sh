...
echo "WELCOME TO THE DHCP DELETE-A-NATOR"
echo ""
echo "OK, What IS The IP You Want To Delete?"
echo "Please Enter It In Correct Format ex: 10.1.2.3"
read delIp
echo "Enter The Mac Address To Delete, Exactly As It Is:"
echo "ex. AA:BB:CC:DD:EE:00"
read NEWMAC
NEWMAC=${NEWMAC,,}
NEWMACLC=${NEWMAC^^}

echo "Going To Delete $delIp $NEWMAC"
echo
